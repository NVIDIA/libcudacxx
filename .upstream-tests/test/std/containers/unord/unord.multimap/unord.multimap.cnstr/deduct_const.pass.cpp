...
int main(int, char**)
{
    ...
    {
    cuda::std::unordered_multimap m { PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} };
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    }

    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42);
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    }

    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42, cuda::std::hash<short>());
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long, cuda::std::hash<short>>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    }

    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42, cuda::std::hash<short>(), cuda::std::equal_to<>());
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long, cuda::std::hash<short>, cuda::std::equal_to<>>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    }

    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42, cuda::std::hash<short>(), cuda::std::equal_to<>(), test_allocator<PC>(0, 44));
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long, cuda::std::hash<short>, cuda::std::equal_to<>, test_allocator<PC>>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    ...
    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42, test_allocator<PC>(0, 47));
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long, cuda::std::hash<int>, cuda::std::equal_to<int>, test_allocator<PC>>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    ...
    {
    cuda::std::unordered_multimap m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, 42, cuda::std::hash<short>(), test_allocator<PC>(0, 48));
    ASSERT_SAME_TYPE(decltype(m), cuda::std::unordered_multimap<int, long, cuda::std::hash<short>, cuda::std::equal_to<int>, test_allocator<PC>>);
    assert(cuda::std::is_permutation(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
