# Dockerfile for libcudacxx_base:host_ppc64le_centos_8.3.2011__target_ppc64le_centos_8.3.2011__gcc_8_cxx_11
...
RUN set -o pipefail; cd /sw/gpgpu/libcudacxx/build\
 ...
 -DLIBCXX_NVCC_HOST_COMPILER=/sw/gpgpu/clang/bin/clang\
