...
int main(int, char**)
{
    ...
    {
    const P arr[] = { {1,1L}, {2,2L}, {1,1L}, {INT_MAX,1L}, {3,1L} };
    cuda::std::multimap m(cuda::std::begin(arr), cuda::std::end(arr), cuda::std::greater<int>(), test_allocator<PC>(0, 42));
    ...
    {
    cuda::std::multimap<int, long> source;
    cuda::std::multimap m(source);
    ...
    {
    cuda::std::multimap<int, long> source;
    cuda::std::multimap m{source};  // braces instead of parens
    ASSERT_SAME_TYPE(decltype(m), decltype(source));
    assert(m.size() == 0);
    }
    ...
    {
    cuda::std::multimap<int, long> source;
    cuda::std::multimap m(source, cuda::std::map<int, long>::allocator_type());
    ASSERT_SAME_TYPE(decltype(m), decltype(source));
    assert(m.size() == 0);
    }

    {
    cuda::std::multimap m{ P{1,1L}, P{2,2L}, P{1,1L}, P{INT_MAX,1L}, P{3,1L} };
    ...
    {
    cuda::std::multimap m({ P{1,1L}, P{2,2L}, P{1,1L}, P{INT_MAX,1L}, P{3,1L} }, cuda::std::greater<int>());
    ...
    {
    cuda::std::multimap m({ P{1,1L}, P{2,2L}, P{1,1L}, P{INT_MAX,1L}, P{3,1L} }, cuda::std::greater<int>(), test_allocator<PC>(0, 43));
    ...
    {
    const P arr[] = { {1,1L}, {2,2L}, {1,1L}, {INT_MAX,1L}, {3,1L} };
    cuda::std::multimap m(cuda::std::begin(arr), cuda::std::end(arr), test_allocator<PC>(0, 44));
    ...
    {
    cuda::std::multimap m({ P{1,1L}, P{2,2L}, P{1,1L}, P{INT_MAX,1L}, P{3,1L} }, test_allocator<PC>(0, 45));
