...
int main(int, char**)
{
    ...
    ASSERT_SAME_TYPE(decltype(m), cuda::std::map<int, const long>);
    ...
    ASSERT_SAME_TYPE(decltype(m), cuda::std::map<int, const long, cuda::std::greater<int>>);
    ...
    {
    const PCC arr[] = { {1,1L}, {2,2L}, {1,1L}, {INT_MAX,1L}, {3,1L} };
    cuda::std::map m(cuda::std::begin(arr), cuda::std::end(arr), cuda::std::greater<int>(), test_allocator<PCC>(0, 42));

    ASSERT_SAME_TYPE(decltype(m), cuda::std::map<int, const long, cuda::std::greater<int>, test_allocator<PCC>>);
    const PCC expected_m[] = { {INT_MAX,1L}, {3,1L}, {2,2L}, {1, 1L} };
    assert(cuda::std::equal(m.begin(), m.end(), cuda::std::begin(expected_m), cuda::std::end(expected_m)));
    ...
    {
    cuda::std::map m{ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} };
    ...
    {
    cuda::std::map m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, cuda::std::greater<int>());
    ...
    {
    cuda::std::map m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, cuda::std::greater<int>(), test_allocator<PC>(0, 43));
    ...
    {
    cuda::std::map m({ PC{1,1L}, PC{2,2L}, PC{1,1L}, PC{INT_MAX,1L}, PC{3,1L} }, test_allocator<PC>(0, 45));
