# Dockerfile for libcudacxx_base:host_x86_64_ubuntu_18.04__target_x86_64_ubuntu_18.04__clang_7_cxx_17
...
RUN set -o pipefail; cd /sw/gpgpu/libcudacxx/libcxx/build\
 ...
 -DLLVM_CONFIG_PATH=$(which llvm-config-7)\
...
RUN set -o pipefail; cd /sw/gpgpu/libcudacxx/build\
 ...
 -DLIBCXX_NVCC_HOST_COMPILER=clang++-7\
