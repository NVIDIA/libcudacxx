...
{
    {
        ...
        cuda::std::multimap m; // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // cannot deduce Key and T from just (Compare)
        cuda::std::multimap m(cuda::std::less<int>{});
    ...
    }
    {
        ...
        NotAnAllocator a;
        cuda::std::multimap m(a); // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // cannot deduce that the inner braced things should be cuda::std::pair and not something else
        cuda::std::multimap m{ {1,1L}, {2,2L}, {3,3L} };
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // cannot deduce that the inner braced things should be cuda::std::pair and not something else
        cuda::std::multimap m({ {1,1L}, {2,2L}, {3,3L} }, cuda::std::less<int>());
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // cannot deduce that the inner braced things should be cuda::std::pair and not something else
        cuda::std::multimap m({ {1,1L}, {2,2L}, {3,3L} }, cuda::std::less<int>(), cuda::std::allocator<PC>());
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // cannot deduce that the inner braced things should be cuda::std::pair and not something else
        cuda::std::multimap m({ {1,1L}, {2,2L}, {3,3L} }, cuda::std::allocator<PC>());
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // since we have parens, not braces, this deliberately does not find the initializer_list constructor
        cuda::std::multimap m(P{1,1L});
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
    {
        // since we have parens, not braces, this deliberately does not find the initializer_list constructor
        cuda::std::multimap m(PC{1,1L});
            // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
    }
